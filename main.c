...
int main()
    ...
    system("cls");
    printf("\n ------------------  Welcome %s  Quiz Game --------------------------",playername);
    ...
    printf("\n    total of 10 questions. Each right answer will be awarded Rs10,00,000!");
...
void help()
    ...
    printf("\n    total 10 questions each right answer will be awarded Rs 1,00,00,000.");
    printf("\n    By this way you can win upto ONE CRORE cash prize in RUPEES...............");
    printf("\n >> You will be given 4 options and you have to press A, B ,C or D for the");
    printf("\n    right option");
